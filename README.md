...
   更新内容：修改removeViewCameraFromWindow接口无效以及自定义相机内存泄漏问题；IDE证书更新3. 版本号：uexVideo-3.0.8	
   更新内容：添加播放完成的监听4. 版本号：uexXunfei-3.0.3	
   更新内容：添加语音识别功能
***### 2016/07/22版本更新记录	####iOS插件：1. 版本号：uexLocalNotification-3.0.8	
   更新内容：新增收到通知和点击通知相关的回调。2. 版本号：uexMobSMS-3.0.1	
   更新内容：新增错误信息返回值
***### 2016/07/09版本更新记录
####iOS插件：
										1. 版本号：uexRongCloud-3.0.0
   更新内容：* 新增融云插件
***
### 2016/07/01版本更新记录
####iOS插件：
										1. 版本号：uexQcloudAV-3.0.1
...
1. 版本号：uexWeiXin-3.0.20	

   更新内容：* 更新SDK版本至1.7.0,支持兼容ipv6
***
### 2016/05/18版本更新记录
####iOS插件：
